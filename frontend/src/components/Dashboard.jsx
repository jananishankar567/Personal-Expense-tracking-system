...
//   // ✅ FILTER STATES (USED NOW → NO WARNINGS)
...
//         // Fetch user
//         const res = await fetch(`${import.meta.env.VITE_API_URL}/auth/dashboard`, {
//           headers: {
...
//   // ⚠️ (you can later replace with DB-based income)
//   const totalIncome = 15000;
//   const totalExpense = expenses.reduce((acc, item) => acc + item.amount, 0);
//   const totalBalance = totalIncome - totalExpense;
